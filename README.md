...
| 物品 | 1071 | `items_db.json` |
| 技能 | 478 | `skills_db.json` |
...
游戏更新公告数据来源于 **Steam Store API**，自动获取官方中文翻译的更新公告。

当公告中提及 `https://playthebazaar.com/patch-notes` 时，插件会额外从官网 CDN 拉取最新中文补丁文档：

- `https://playthebazaar.com/api/cdn/data/data/patch-notes.json`
- `https://playthebazaar.com/api/cdn/data/docs/pn/.../..._zh_CN.md`
...
- 英雄识别动态维护：`/tbzupdate` 后自动根据数据重建英雄列表，减少新英雄更新时的代码改动
...
| `/tbzpatch [版本号]` | 查询官网中文补丁说明（默认最新） | `/tbzpatch` 或 `/tbzpatch 11.0` |
